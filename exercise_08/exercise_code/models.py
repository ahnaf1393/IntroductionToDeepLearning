...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20, num_classes=10):
        super().__init__()
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None, num_classes=10):
        super().__init__()
        # set hyperparams
        self.hparams = hparams
        self.encoder = encoder
